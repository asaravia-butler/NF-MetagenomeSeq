...
if [ ${MODE} == "processing" ]; then
    ...
    nextflow log ${RUN_NAME} -f name,script > processing_scripts/nextflow_processing_info_GLlbnMetag.txt
    echo nextflow log ${RUN_NAME} -f name,script >> processing_scripts/nextflow_processing_info_GLlbnMetag.txt
    echo "Nextflow processing info written to processing_scripts/nextflow_processing_info_GLlbnMetag.txt"
